...
static void hoist(Instruction &I, const DominatorTree *DT, const Loop *CurLoop,
                  LoopSafetyInfo *SafetyInfo, MemorySSAUpdater *MSSAU,
  ...
  for (DomTreeNode *DTN : reverse(Worklist)) {
    ...
    for (BasicBlock::iterator II = BB->end(); II != BB->begin();) {
      ...
      if (isInstructionTriviallyDead(&I, TLI)) {
        ...
        salvageDebugInfo(I);
        ++II;
        removeFromAnalyses(&I, CurAST, MSSAU);
        I.eraseFromParent();
        Changed = true;
        continue;
      }
  ...
  for (DomTreeNode *DTN : Worklist) {
    ...
    for (BasicBlock::iterator II = BB->begin(), E = BB->end(); II != E;) {
      ...
      if (CurLoop->hasLoopInvariantOperands(&I) &&
        ...
        hoist(I, DT, CurLoop, SafetyInfo, MSSAU, ORE);
        Changed = true;
        continue;
      }
      ...
      if (I.getOpcode() == Instruction::FDiv &&
        ...
        hoist(*ReciprocalDivisor, DT, CurLoop, SafetyInfo, MSSAU, ORE);
        Changed = true;
        continue;
      }
